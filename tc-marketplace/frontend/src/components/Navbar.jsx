    ...
    <nav 
      ...
      <div className="flex justify-between items-center px-6 py-3  container max-w-[1100px] mx-auto ">
        ...
        <div className="space-x-4 items-center">
            ...
            <Link to="/signup" className={`${isLight ? 'bg-lime-500 text-green-950' : 'bg-amber-400 text-green-900'} px-2.5 py-1.5 rounded-xl hover:${isLight ? 'bg-lime-600' : 'bg-amber-300'} duration-200 shadow-lg hover:shadow-xl`}>
              Sign Up
            </Link>
        </div>
      </div>
